...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', default='1209_v2', type=str)
    ...
    parser.add_argument('--data', default='cora',
                        ...
                        type=str)
    parser.add_argument('--use_intermediate_embedding', default=0, type=str)
    ...
    parser.add_argument('--pooling_opt', default=2, help='0:avg,1:max,2:attention,3:sum',
                        type=int)
    parser.add_argument('--num_repeats', default=0, type=int)
